...
<section class="sec">
  <div class="wrap">
    ...
    <div class="video-card reveal" id="ceremony-video">
      <div class="video-wrap" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;background:#000;">
        <iframe 
          style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" 
          src="https://www.youtube-nocookie.com/embed/dTVtfzCV3Aw?rel=0&modestbranding=1" 
          title="Yahshua Medical Clinics Ltd - Grand Opening Ceremony &amp; Facility Tour" 
      ...
      <div class="video-body">
        <div class="video-info">
          ...
          <p>Official video coverage celebrating 24/7 quality healthcare, modern equipment and compassionate clinical leadership in Nyagatare.</p>
        </div>
        <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap">
          <a class="btn btn-green" href="https://www.youtube.com/watch?v=dTVtfzCV3Aw" target="_blank" rel="noopener">&#9658; Open on YouTube</a>
        </div>
      </div>
    </div>
  </div>
