...
<meta name="keywords" content="Yahshua Medical Clinics, clinic Nyagatare, hospital Rwanda, 24/7 clinic, dental OPG, X-ray Nyagatare, RSSB clinic">
...
<section class="cta-band">
  <div class="wrap reveal">
    ...
    <p>Our team is on duty 24 hours a day, 7 days a week, 365 days a year. Walk in any time or call ahead so we can prepare for you.</p>
  ...
  <div class="wrap">
    <div class="fgrid">
      ...
      <div>
        <h4>Our Services</h4>
        <ul>
          <li><a href="services.html">General Medicine &amp; X-Ray</a></li>
          <li><a href="services.html">Minor Surgery</a></li>
          <li><a href="services.html">Gynecology &amp; Obstetrics OPD</a></li>
          <li><a href="services.html">Dental &amp; OPG X-Ray</a></li>
...
SERVICES = [
    ("&#129658;", "General Medicine &amp; X-Ray",
     "Complete adult consultation, diagnosis and treatment by our General Practitioners, backed by on-site general X-Ray imaging.",
     ["Adult outpatient consultations", "Chronic disease follow-up", "General X-Ray imaging", "Medical check-ups &amp; certificates"], False),
    ("&#128137;", "Minor Surgery",
     "Safe, sterile minor surgical procedures performed by experienced clinicians in our dedicated procedure room.",
     ["Wound care, suturing &amp; dressing", "Abscess incision &amp; drainage", "Excision of small lumps", "Post-operative follow-up"], True),
    ("&#127973;", "All OPD Services",
     "A full outpatient department covering triage, consultation, cashier, pharmacy and treatment, organised for a short, clear patient journey.",
     ["Reception &amp; triage", "Consultation rooms", "Injection &amp; dressing room", "Nursing service"], False),
    ("&#129656;", "Gynecology &amp; Obstetrics OPD",
     "Dedicated women's health care, from routine gynecological consultation to antenatal follow-up.",
     ["Gynecological consultations", "Antenatal &amp; postnatal care", "Reproductive health advice", "Ultrasound referral support"], True),
    ("&#129463;", "Dental Services &amp; OPG X-Ray",
     "A complete dental unit led by a Dental Surgeon and Dental Therapist, with digital OPG (panoramic) X-Ray on site.",
     ["OPG panoramic &amp; dental X-Ray", "Scaling &amp; professional cleaning", "Fillings &amp; restorations", "Tooth extraction &amp; minor oral surgery",
      "Root canal treatment", "Dentures &amp; prosthetics", "Braces / orthodontic advice", "Teeth whitening &amp; cosmetic dentistry"], False),
    ("&#128300;", "Laboratory",
     "A well-equipped laboratory delivering accurate, timely results so treatment can start without delay, available day and night.",
     ["Haematology &amp; biochemistry", "Malaria, HIV &amp; rapid tests", "Urine, stool &amp; microbiology", "Pregnancy &amp; hormonal tests"], True),
    ("&#128118;", "Pediatrics OPD",
     "Gentle, child-focused care for newborns, infants and children, with growth monitoring and nutrition guidance.",
     ["Child consultations", "Growth &amp; nutrition monitoring", "Treatment of childhood illness", "Parent counselling"], False),
    ("&#127973;", "Physiotherapy",
     ...
     ["Musculoskeletal &amp; back pain therapy", "Post-operative &amp; fracture rehabilitation", "Stroke &amp; neurological rehabilitation", "Sports injury management", "Joint mobilisation &amp; therapeutic exercise", "Pediatric &amp; geriatric physiotherapy"], False),
    ("&#128105;&#8205;&#128105;&#8205;&#128102;", "Family Planning",
     "Confidential family planning counselling and a range of modern methods, offered with respect and privacy.",
     ["Counselling &amp; method choice", "Short and long-term methods", "Follow-up &amp; management", "Couple counselling"], True),
    ("&#128137;", "Vaccination",
     "Routine childhood immunisation and adult vaccination, administered by trained nurses following national guidelines.",
     ["Childhood immunisation", "Adult &amp; travel vaccines", "Tetanus prophylaxis", "Vaccination records"], False),
    ("&#128715;", "Hospitalization",
     "Comfortable observation and admission beds with 24-hour nursing care and doctor review for patients who need to stay.",
     ["24-hour nursing care", "Observation &amp; admission beds", "IV therapy &amp; monitoring", "Daily doctor review"], True),
]
...
DOCTORS = [
    ("Dr. KOLONELI Diedone", "Clinical Director &middot; General Practitioner", "0788469406", "doctor-koloneli.jpg"),
    ("Dr. James NDAHIGWA", "General Practitioner", "0784274960", "doctor-ndahigwa.jpg"),
    ("Dr. SHIMA GAPIRA Patrick", "General Practitioner", "0798056172", "doctor-shima.jpg"),
    ("Dr. NSENGIMANA Theodole", "Dental Surgeon", "0786997031", "doctor-nsengimana.jpg"),
    ("IRADUKUNDA Irene", "Dental Therapist", "0786137333", "therapist-irene.jpg"),
]
...
GALLERY = [
    ...
    ("flow-chart.jpg", "Our patient flow chart"),
]
...
def initials(name):
    parts = [p for p in re.sub(r"Dr\.?|&middot;", " ", name).replace(".", " ").split() if p]
    letters = [p[0].upper() for p in parts if p[0].isalpha()]
    return "".join(letters[:2]) if letters else "Y"


def doc_cards():
    out = ""
    for name, role, tel, img in DOCTORS:
        out += f"""
      <article class="doc-card reveal">
        <div class="doc-photo">
          <!-- To publish a real photo: save it as assets/img/{img} and replace this block with
               <img src="assets/img/{img}" alt="{name}"> -->
          <div class="doc-ph">
            <span class="monogram">{initials(name)}</span>
            <span class="ph-label">Professional photo<br>coming soon</span>
          </div>
        </div>
        <div class="doc-body">
          <h3>{name}</h3>
          <span class="doc-role">{role}</span>
          <a class="doc-tel" href="tel:{tel}">&#9742; {tel}</a>
        </div>
      </article>"""
    return out
...
def build_index():
    ...
    return head("Yahshua Medical Clinics Ltd | YAHWEH SAVES | 24/7 Clinic in Nyagatare, Rwanda",
                "Yahshua Medical Clinics Ltd, Nyagatare. Affordable, patient-centred healthcare open 24/7. General medicine, X-Ray, dental with OPG, laboratory, pediatrics, physiotherapy, gynecology, minor surgery and hospitalization.") + header("index.html") + f"""
<main>
  ...
  <div class="wrap">
    <div class="hero-inner">
      ...
      <ul class="hero-badges">
        <li>&#9200; Open 24/7</li>
        <li>&#129658; General Medicine &amp; X-Ray</li>
        <li>&#129463; Dental with OPG X-Ray</li>
        <li>&#128300; Laboratory</li>
        <li>&#127939; Physiotherapy</li>
        <li>&#128715; Hospitalization</li>
        <li>&#127974; 14+ Insurances Accepted</li>
      </ul>
  ...
  <div class="wrap">
    <div class="split">
      <div class="reveal">
        ...
        <p>From our home on EN 58 ST in Nyagatare, our doctors, dental surgeon, nurses and laboratory team work around the clock so that quality care is never more than a phone call away.</p>
...
<section class="stats">
  <div class="wrap">
    <div class="grid">
      ...
      <div><div class="num" data-count="11" data-suffix="+">0</div><div class="lbl">Clinical departments</div></div>
      <div><div class="num" data-count="14" data-suffix="+">0</div><div class="lbl">Insurances accepted</div></div>
    </div>
  </div>
</section>
...
<section class="sec sec-soft">
  <div class="wrap">
    <div class="split">
      ...
      <div class="reveal">
        <span class="eyebrow">Simple &amp; clear</span>
        <h2>Your patient journey</h2>
        <p>Every visit follows a clear, well-signposted path so you always know where to go next.</p>
        <ul class="value-list" style="flex-direction:column;align-items:flex-start">
          <li>1. Reception: registration &amp; insurance check</li>
          <li>2. Triage: vital signs &amp; priority</li>
          <li>3. Your department: Medicine, Gynecology, Pediatrics, Dental, Physiotherapy, Minor Surgery or Nursing</li>
          <li>4. Laboratory / X-Ray if requested</li>
          <li>5. Cashier: billing &amp; insurance settlement</li>
          <li>6. Pharmacy, treatment or hospitalization</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="split">
      <div class="reveal">
        ...
        <p>The clinic brings together general medicine and X-Ray, minor surgery, a full outpatient department, gynecology and obstetrics, a complete dental unit with OPG X-Ray, laboratory, pediatrics, physiotherapy, family planning, vaccination and hospitalization, all on one well-kept campus.</p>
...
<section class="sec sec-soft">
  <div class="wrap">
    <div class="split">
      <div class="reveal">
        <span class="eyebrow">How a visit works</span>
        <h2>Our Patient Flow Chart</h2>
        <p>From reception to triage, from your department to the cashier, our flow chart keeps every visit organised and every patient informed.</p>
        <ul class="value-list" style="flex-direction:column;align-items:flex-start">
          <li>Reception &rarr; Triage</li>
          <li>General Medicine &middot; Gynecology &middot; Pediatrics &middot; Dental</li>
          <li>Laboratory &middot; X-Ray &middot; Nursing Service &middot; Minor Surgery</li>
          <li>Cashier &rarr; Pharmacy / Treatment / Hospitalization</li>
        </ul>
      </div>
...
def build_services():
    ...
    return head("Our Services | Yahshua Medical Clinics Ltd",
                "Services at Yahshua Medical Clinics Ltd: general medicine and X-Ray, minor surgery, OPD, gynecology and obstetrics, dental with OPG X-Ray, laboratory, pediatrics, physiotherapy, family planning, vaccination and hospitalization. Open 24/7.") \
...
<section class="sec">
  <div class="wrap">
    <div class="sec-head center">
      ...
      <h2>Complete care, one campus</h2>
      <p>YAHSHUA MEDICAL CLINICS LTD prides a wide range of health care services, delivered by qualified doctors, nurses and technicians.</p>
      <div class="rule"></div>
    </div>
...
<section class="sec sec-soft" id="dental">
  <div class="wrap">
    <div class="sec-head center">
      ...
      <p>Led by our Dental Surgeon <strong>Dr. NSENGIMANA Theodole</strong> and Dental Therapist <strong>IRADUKUNDA Irene</strong>.</p>
      <div class="rule"></div>
    </div>
    <div class="grid g4">
      <article class="card reveal"><span class="tag">Imaging</span><h3>OPG Panoramic X-Ray</h3><p>Full-mouth panoramic imaging for accurate diagnosis, extractions, implants and orthodontic planning, plus standard dental X-Ray.</p></article>
    ...
    <div class="sec-head center" style="margin-top:56px;margin-bottom:24px">
      <h3>Dental Materials &amp; Equipment Gallery</h3>
      <p>This space is reserved for photos of our dental materials, equipment and treatment results.</p>
    </div>
    <div class="grid g3">
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space 1</strong>Save your image as <code>assets/img/dental-1.jpg</code></div>
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space 2</strong>Save your image as <code>assets/img/dental-2.jpg</code></div>
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space 3</strong>Save your image as <code>assets/img/dental-3.jpg</code></div>
      <div class="upload-box reveal"><span class="big">&#129463;</span><strong>Photo space 4</strong>Save your image as <code>assets/img/dental-4.jpg</code></div>
      <div class="upload-box reveal"><span class="big">&#129463;</span><strong>Photo space 5</strong>Save your image as <code>assets/img/dental-5.jpg</code></div>
      <div class="upload-box reveal"><span class="big">&#129463;</span><strong>Photo space 6</strong>Save your image as <code>assets/img/dental-6.jpg</code></div>
    </div>
  </div>
</section>
...
<section class="sec">
  <div class="wrap">
    <div class="grid g2">
      <article class="card reveal"><div class="ico-lg">&#9200;</div><h3>Operating Hours</h3><p><strong>24/7</strong>: 24 hours a day, 7 days a week, 365 days a year. Emergencies, laboratory and nursing service are always staffed.</p></article>
      <article class="card alt reveal"><div class="ico-lg">&#128179;</div><h3>Payment &amp; Insurance</h3><p>We work with RSSB, MMI, RADIANT, SANLAM, BRITAM, UAP/Old Mutual, Eden Care, Equity, ASA International, UBF, PSF Insurance, MIS UR and more. <strong>All payment modes accepted.</strong> <a href="insurance.html">See the full list &rarr;</a></p></article>
    </div>
  </div>
</section>
...
def build_doctors():
    return head("Our Doctors | Yahshua Medical Clinics Ltd",
                "Meet the medical team of Yahshua Medical Clinics Ltd: general practitioners, a dental surgeon and a dental therapist serving Nyagatare 24/7.") \
        + header("doctors.html") \
        + page_hero("Our Medical Team", "Six doctors: one Dental Surgeon and five General Practitioners, supported by nurses, laboratory and dental staff.", "hospitalization.jpg", "Our Doctors") + f"""
<main>
<section class="sec">
  <div class="wrap">
    <div class="sec-head center">
      <span class="eyebrow">Meet the team</span>
      <h2>Doctors &amp; Clinical Staff</h2>
      <p>Our team is available around the clock. You can reach a clinician directly on the numbers below, or call reception on <a href="tel:{TEL_RECEP}">{TEL_RECEP}</a>.</p>
      <div class="rule"></div>
    </div>
    <div class="grid g3">{doc_cards()}
      <article class="doc-card reveal">
        <div class="doc-photo"><div class="doc-ph"><span class="monogram">&#10133;</span><span class="ph-label">Space reserved for<br>additional team members</span></div></div>
        <div class="doc-body">
          <h3>More of our team</h3>
          <span class="doc-role">Nurses, laboratory &amp; support staff</span>
          <a class="doc-tel" href="tel:{TEL_RECEP}">&#9742; {TEL_RECEP}</a>
        </div>
      </article>
    </div>

    <div class="upload-box reveal" style="margin-top:36px;text-align:left">
      <strong>&#128247; Doctor profile photo spaces are reserved</strong>
      Each profile card above has a photo slot ready. To publish a portrait, save it in <code>assets/img/</code> using the file name noted in that card's HTML comment
      (<code>doctor-koloneli.jpg</code>, <code>doctor-ndahigwa.jpg</code>, <code>doctor-shima.jpg</code>, <code>doctor-nsengimana.jpg</code>, <code>therapist-irene.jpg</code>)
      and swap the placeholder block for the <code>&lt;img&gt;</code> tag already prepared in the comment. Square portraits of about 800&times;800 pixels look best.
    </div>
  </div>
</section>
...
<section class="sec sec-soft">
  <div class="wrap">
    <div class="grid g3">
      <article class="card reveal"><div class="ico-lg">&#129658;</div><h3>5 General Practitioners</h3><p>Experienced GPs covering general medicine, OPD, pediatrics, gynecology consultations and minor surgery, with doctors on duty day and night.</p></article>
      <article class="card alt reveal"><div class="ico-lg">&#129463;</div><h3>1 Dental Surgeon</h3><p>A qualified dental surgeon supported by a dental therapist, offering the full range of dental treatment with OPG X-Ray on site.</p></article>
      <article class="card reveal"><div class="ico-lg">&#129657;</div><h3>Nursing &amp; Laboratory</h3><p>A dedicated nursing service and laboratory team, ensuring continuous care, accurate results and safe hospitalization.</p></article>
    </div>
  </div>
</section>
...
def build_insurance():
    return head("Insurance &amp; Payments | Yahshua Medical Clinics Ltd",
        ...
        + page_hero("Insurance &amp; Payments", "We work with many insurance providers and accept all payment modes, so care stays affordable.", "front-signage.jpg", "Insurance") + f"""
<main>
<section class="sec">
  <div class="wrap">
    <div class="sec-head center">
      ...
      <p>Bring your valid insurance card and national ID to reception and we will handle the rest.</p>
      <div class="rule"></div>
    </div>
    {ins_grid()}
  </div>
...
def build_gallery():
    ...
    return head("Gallery | Yahshua Medical Clinics Ltd",
                "Photo gallery of Yahshua Medical Clinics Ltd in Nyagatare: reception, waiting areas, consultation corridors, hospitalization wing, parking and entrance.") \
        + header("gallery.html") \
...
<section class="sec">
  <div class="wrap">
    ...
    <div class="grid g3">
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space</strong>Add to <code>assets/img/</code></div>
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space</strong>Add to <code>assets/img/</code></div>
      <div class="upload-box reveal"><span class="big">&#128247;</span><strong>Photo space</strong>Add to <code>assets/img/</code></div>
    </div>
  </div>
        ...
        <form class="appt" id="apptForm">
          ...
          <div class="field"><label for="service">Service needed</label>
            <select id="service" name="service">
              <option>General Medicine &amp; X-Ray</option>
              <option>Minor Surgery</option>
              <option>Gynecology &amp; Obstetrics</option>
              <option>Dental / OPG X-Ray</option>
          ...
          <div class="field"><label for="insurance">Insurance (optional)</label><input id="insurance" name="insurance" placeholder="e.g. RSSB, MMI, Radiant..."></div>
